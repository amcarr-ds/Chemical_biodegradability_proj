...
'confusionMatrix(Test_Op$lda, Test_Op$obs, positive = "RB")
plot(lda_ROC, legacy.axes = TRUE)'
```
...
rf_fit = randomForest(x=biodeg_train, y = response_train, preProc = c("center", "scale"), metric = "ROC", trControl = ctrl)
