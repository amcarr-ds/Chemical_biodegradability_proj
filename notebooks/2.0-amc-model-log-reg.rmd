...
```{r}
write.csv(test_pred_model_outcomes,"../data/05-06_biodeg_test_outcomes.csv", row.names = FALSE)
write.csv(data.frame(models_compare_summ$models, models_compare_summ$statistics),"../data/05-06_biodeg_test_resamp_results.csv", row.names = FALSE)
```
