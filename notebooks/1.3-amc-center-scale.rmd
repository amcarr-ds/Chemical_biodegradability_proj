...
train_x01_trans_df02_pca01 <- principal(r = train_x01_trans_df02, rotate = "varimax", nfactors = 32)
train_x01_trans_df02_pca01
train_x01_trans_df02_pca01$values
plot(train_x01_trans_df02_pca01$values, type = "b", main = "Plot of Eigenvalues", ylab = "Value", xlab = "Component")
abline(h = 1, lty = 2)


train_x01_trans_df02_pca02 <- princomp(x = train_x01_trans_df02)
train_x01_trans_df02_pca02
screeplot(train_x01_trans_df02_pca02, type = "lines")
abline(h = 1, lty = 2)
```
