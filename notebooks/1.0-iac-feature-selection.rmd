...
```{r}
write.csv(biodeg_train_features,"../data/biodeg_train_trans_features.csv", row.names = FALSE)
write.csv(biodeg_test_features,"../data/biodeg_test_trans_features.csv", row.names = FALSE)
```
